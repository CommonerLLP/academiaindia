...
sync-agents: $(PYTHON)
	...
	@echo "Diff (header lines only should differ):"
	@bash -c 'diff <(grep -v "^#\|^Generated by\|^Rule [1-4]\|^This file\|^$$" CLAUDE.md | head -5) \
	               <(grep -v "^#\|^Generated by\|^Rule [1-4]\|^This file\|^$$" AGENTS.md | head -5) \
	  && echo "  in sync" || true'
